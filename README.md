# İbrahim Can Düven - Personal Portfolio Website
...
4. Use the **"Let's get in touch"** button to open the contact form on the Contact page.  
5. Fill out the form and submit to send an email via Formspree.  
...
- Modify the email address in the `mailto:` links and Formspree action URLs.  
